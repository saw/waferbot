...
function handleEntity(text, entities) {
	...
	entities.forEach((entity) => {
		console.log(entity.type);
		if(entity.type === 'builtin.encyclopedia.people.person' || entity.type === 'builtin.personName') {
			retMessage = randomItem([`${entity.entity} is a bit of a cunt`, `Such a twat.`, 'huh', `oh i like ${entity.entity}`, `never met them`, `oh ${entity.entity}! I should interview them!`]);
		} 
