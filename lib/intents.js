...
const intentHandlers = {
	...
	'query'		: function(text, intent) {
		if(intent.entities.length > 0) {
			...
			return randomItem([
				`${entity}? hmmm`,
				`Why are you asking me about ${entity}?`,
				`Oh..._${entity}_.`,
				`I could not be bothered to even think about ${entity}`,
				`Try this: http://www.google.com/search?q=${entity}`
			])
		}
...
export {intents, getIntent, handleIntent, randomItem}